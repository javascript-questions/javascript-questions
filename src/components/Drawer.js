...
const Drawer = ({ updatedAt }) => (
    ...
    <div>
      ...
      <a href="https://github.com/andreruffert/javascript-questions" target="_blank" rel="noopener" aria-label="JavaScript Questions Github repository">
        <svg width="16" height="16" viewBox="0 0 16 16" version="1.1" aria-hidden="true" fill="currentColor">
      ...
      <div style={{ marginTop: 'auto' }}>
        ...
        <ul>
          ...
          <li><small><a href="https://github.com/lydiahallie/javascript-questions" target="_blank" rel="noopener">Source</a></small></li>
        </ul>
      </div>
    </div>
	</details>
